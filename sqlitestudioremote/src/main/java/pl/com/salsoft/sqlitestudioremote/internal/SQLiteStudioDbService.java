...
public class SQLiteStudioDbService {
    ...
    private SQLiteDatabase getDb(String name) {
        ...
        final String path = context.getDatabasePath(name).getPath();
        SQLiteDatabase readOnlyDb = SQLiteDatabase.openDatabase(path, null, SQLiteDatabase.OPEN_READONLY, null);
        SQLiteStudioDbOpenHelper helper = new SQLiteStudioDbOpenHelper(context, name, readOnlyDb.getVersion());
